...
!define MUI_WELCOMEPAGE_TEXT "ClipManager is a lightweight clipboard manager with image support, file/folder copy, snippets, and smart content detection.$\n$\nPress Ctrl+Shift+V to open your clipboard history at any time."
...
;-----------------------------------------
    ...
    ; Remove all app data: history, snippets, images, first-run marker
    Delete "$APPDATA\ClipManager\history.txt"
    Delete "$APPDATA\ClipManager\snippets.txt"
    Delete "$APPDATA\ClipManager\.firstrun_done"
